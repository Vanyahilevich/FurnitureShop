...
export const useChangeInfoUser = () => {
  ...
  return useMutation({
    ...
    mutationFn: async (data: any) => {
      try {
        const response = await axios.post(serverRoutes.changeInfo, data, {
          withCredentials: true,
        });
        return response.data;
      } catch (error) {
...
export const useChangeEmailUser = () => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationKey: ["auth"],
    mutationFn: async (data: any) => {
      try {
        const response = await axios.post(serverRoutes.changeEmail, data, {
          withCredentials: true,
        });
        return response.data;
      } catch (error) {
...
export const useChangeImageUser = () => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationKey: ["auth"],
    mutationFn: async (data: any) => {
      try {
        const response = await axios.post(serverRoutes.changeImage, data, {
          withCredentials: true,
        });
        return response.data;
      } catch (error) {
