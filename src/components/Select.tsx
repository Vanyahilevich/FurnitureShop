            ...
            <Listbox value={value} onChange={onChange}>
                <div className="relative mt-1">
                    <Listbox.Button
                        ...
                        <span className="cursor-pointer block truncate text-darkBlueHover text-lg">Category</span>
                        <span className={twMerge("cursor-pointer absolute inset-y-0 right-0 flex items-center pr-2 ease-in duration-150", isOpen && 'rotate-90 translate-y-1 delay-75 ease-in duration-150  ')}>
              <SlArrowRight
              ...
              />
                        ...
                        <Listbox.Options
                            className="absolute w-72 overflow-auto pt-3 bg-white shadow-lg focus:outline-none sm:text-sm">
